    ...
    export default {
        ...
        methods: {
            ...
            endEditing(product) {
                ...
                axios.put(`/api/products/${product.id}`, {name, units, price, description}).then(response => {
                    this.products[index] = product;
                });
            },
            // called when we want to add a new product.
            addProduct(product) {
                ...
                axios.put('/api/products/', {name, units, price, description, image}).then(response => {
